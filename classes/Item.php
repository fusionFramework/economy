...
class Item {
	...
	public function to_user($user=null, $origin = "app", $amount = 1, $location = 'inventory', $ignore_limit=false)
	{
		...
		else
		{
			if($location == 'inventory' && $ignore_limit == false)
			{
				...
				{
					Throw new Item_Exception_Inventory('Inventory is full');
				}
			}
			...
			{
				Throw new Item_Exception('You can\'t take away items with Item::to_user()');
			}
	 ...
	 *
	 * @return Model_User_Item|boolean
	 */
