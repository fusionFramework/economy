 ...
 */
class Fusion_Item_Command_Move_Shop extends Item_Command_Move {
	...
	public function perform($item, $amount, $data = null)
	{
		...
		{
			return Item_Result::factory($name . ' is locked to your account.', 'error');
		}
		else if (!$item->move('shop', $amount))
		{
