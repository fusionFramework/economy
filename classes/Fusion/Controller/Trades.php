 ...
 */
class Fusion_Controller_Trades extends Controller_Fusion_Site
{
	/**
	...
	public function action_create()
	{
		...
		else
		{
			...
			$this->_tpl->max_items = Kohana::$config->load('trade.lots.max_items');
			$this->_tpl->max_type = (Kohana::$config->load('trade.lots.count_amount')) ? 'items' : 'stacks';
	...
	public function action_bid()
	{
		...
		else
		{
			...
			$this->_tpl->max_items = Kohana::$config->load('trade.bids.max_items') - 1;
			$this->_tpl->max_type = (Kohana::$config->load('trade.bids.count_amount')) ? 'items' : 'stacks';
	...
	{
		$id = $this->request->param('id');
		$config = Kohana::$config->load('trade.bids');
